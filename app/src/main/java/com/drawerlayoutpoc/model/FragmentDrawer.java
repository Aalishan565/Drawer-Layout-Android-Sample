...
import com.drawerlayoutpoc.adapter.NavigationDrawerAdapter;
...
public class FragmentDrawer extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        TextView tv_1 = (TextView) layout.findViewById(R.id.tv_1);
        TextView tv_2 = (TextView) layout.findViewById(R.id.tv_2);
        TextView tv_3 = (TextView) layout.findViewById(R.id.tv_3);

        textViewEmpName.setText("Name ");
        textViewSite.setText("Other");
        tv_1.setText("Tv one");
        tv_2.setText("Tv two");
        tv_3.setText("Tv three");
        return layout;
    }
